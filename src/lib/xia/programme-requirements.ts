...
export const programmeRules: ProgrammeRule[] = [
  ...
  /* --------------------------------- UAE ---------------------------------- */
  {
    ...
    requirements: [
      ...
      minimumStayFits("The Golden Visa does not lapse for time spent outside the UAE, unlike an ordinary residence visa — which is the main reason people choose it."),
