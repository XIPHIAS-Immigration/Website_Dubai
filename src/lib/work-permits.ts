...
export const workPermitCountries: WorkPermitCountry[] = [
  ...
  },
  {
    ...
    code: "IT",
    region: "Europe",
    image: "/images/skilled/italy/italy-digital-nomad-visa.webp",
    href: "/skilled/italy/italy-digital-nomad-visa",
    permitTypes: ["Digital Nomad Visa", "Highly qualified remote work", "EU Blue Card direction"],
    advisoryFocus: "Remote income continuity, qualification evidence, accommodation, and consular file readiness for the digital nomad route.",
    processingSignal: "Relevant for experienced remote professionals and highly qualified specialists with stable non-Italian income.",
    proofPoints: ["Remote income proof", "Higher qualification or experience", "Accommodation and insurance"],
    routeReadiness: [
      { label: "Route basis", value: "Remote income", detail: "The digital nomad route reviews income level, continuity, and remote basis." },
      { label: "Profile fit", value: "Qualification", detail: "Degree or documented professional experience supports the highly qualified test." },
      { label: "Readiness", value: "Housing + cover", detail: "Accommodation and health cover are checked at consular stage." },
    ],
    documentChecklist: ["Resume/CV", "Passport", "Remote work contracts", "Income proof", "Accommodation proof", "Health insurance"],
    advisorChecks: ["Income threshold fit", "Remote work evidence", "Qualification documentation", "Consular appointment readiness"],
  },
  {
    slug: "new-zealand",
    country: "New Zealand",
    code: "NZ",
    region: "Oceania",
    image: "/images/skilled/new-zealand/green-list-work-to-residence.webp",
    href: "/skilled/new-zealand/green-list-work-to-residence-visa",
    permitTypes: ["Green List Work to Residence", "Green List Straight to Residence", "Accredited Employer Work Visa direction"],
    advisoryFocus: "Green List occupation match, employer accreditation, qualification and registration evidence, and residence sequencing.",
    processingSignal: "Strong fit for healthcare, engineering, ICT, and trades professionals on Green List occupations with employer support.",
    proofPoints: ["Green List occupation match", "Accredited employer offer", "Qualification or registration proof"],
    routeReadiness: [
      { label: "Route basis", value: "Occupation + offer", detail: "Green List routes need an eligible occupation and an accredited employer offer." },
      { label: "Profile fit", value: "Registration", detail: "Some occupations also require New Zealand professional registration." },
      { label: "Residence path", value: "Direct or 2 yrs", detail: "Tier 1 goes straight to residence; Tier 2 reaches residence after two years of work." },
    ],
    documentChecklist: ["Resume/CV", "Passport", "Job offer from accredited employer", "Qualification proof", "Registration evidence if applicable", "Health and character documents"],
    advisorChecks: ["Green List occupation fit", "Employer accreditation status", "Tier 1 vs Tier 2 sequencing", "Registration requirement check"],
  },
];
