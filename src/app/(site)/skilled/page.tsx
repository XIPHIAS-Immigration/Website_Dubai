...
const config: VerticalConfig = {
  ...
  heroStats: [{ v: "9", u: "countries" }, { v: "PR", u: "pathways" }, { v: "Family", u: "included" }, { v: "17 yrs", u: "advising" }],
  ...
  destSub: "Nine skilled-migration destinations.",
  ...
  countries: [
    ...
    { name: "France", slug: "france", region: "Europe", img: "/images/skilled/france/france-skilled.webp", note: "EU Blue Card · talent card" },
