...
import EstimatorSplit from "./EstimatorSplit";
import EstimatorStepper from "./EstimatorStepper";

/**
 * Owner preview: flip between the 3 navy/gold cost-estimator / tool layouts.
 * Pick one → it applies to /cost-estimator, /eligibility, the eligibility-check pages, and xiphias-program-index.
 */
const VARIANTS = [
  { key: "panel", label: "① Tool Panel", Comp: EstimatorPanel },
  { key: "split", label: "② Split Estimator", Comp: EstimatorSplit },
  { key: "stepper", label: "③ Guided Stepper", Comp: EstimatorStepper },
] as const;

export default function EstimatorSamplesSwitcher({ serifClass }: { serifClass: string }) {
  ...
  return (
    <div className="relative">
      ...
      <div
        ...
        role="group"
        aria-label="Estimator sample variant"
      >
