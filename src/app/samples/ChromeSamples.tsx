      ...
      <div className="mx-auto max-w-6xl">
        <div className="flex flex-col justify-between gap-8 border-b pb-12 lg:flex-row lg:items-end" style={{ borderColor: `${GOLD}26` }}>
          <div>
            ...
            <p className="mt-3 max-w-sm text-[14px] leading-relaxed text-white/55">A private global-mobility practice. Residency, citizenship and second passports — arranged with discretion since 2009.</p>
          </div>
